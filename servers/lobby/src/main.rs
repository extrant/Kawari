...
async fn main() {
    ...
    loop {
        ...
        tokio::spawn(async move {
            loop {
                match read_packet(&mut connection.socket).await {
                    Ok(buf) => {
                            ...
                            match &segment.data {
                                ...
                                SegmentData::Ipc(data) => match &data.data {
                                    ClientLobbyIpcData::LoginEx {
                                        ...
                                        connection.login(*sequence, session_id, version_info).await;
                                    }
                                    ...
                                    ClientLobbyIpcData::GameLogin {
                                        ...
                                        {
                                            let ipc_segment =
                                                CustomIpcSegment::new(CustomIpcData::GetActorId {
